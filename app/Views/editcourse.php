...
<div class="pr-16 mt-14 sm:mr-8 sm:ml-80 sm:mt-4 flex justify-center items-center">
  <div class="flex items-center justify-center shadow-lg px-8 py-4">
    <form class="w-full max-w-lg" method="post" action="<?= base_url('editcourse'); ?>">
      ...
      <div class="flex flex-wrap -mx-3 mb-6">
        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
          ...
          <input
            ...
            id="grid-first-name" type="text" name="course" placeholder="BCA"  value="<?= set_value('course'), $course['c_name']; ?>">
        ...
        <div class="w-full px-3 py-4">
          ...
          <textarea id="message" rows="4"
            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
            placeholder="Department Description..." name="description"  > <?= set_value('description') ?: $course['description']; ?>
              </textarea>
              <div class="pl-4 text-red-600">
            <?php
